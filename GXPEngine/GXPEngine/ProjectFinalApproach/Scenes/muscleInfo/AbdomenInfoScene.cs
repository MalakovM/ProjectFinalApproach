...
{
    class AbdomenInfoScene : Scene
    {
        public AbdomenInfoScene() : base()
        {
            // Set scene content
            ...
            Sprite exercise = new Sprite("images/exercises/Abdomen.png");
            ...
            name.SetXY(300, 40);
            name.Text("                                                                    The Externus Abdominis", 1920 / 2 - description1.width, 100);
