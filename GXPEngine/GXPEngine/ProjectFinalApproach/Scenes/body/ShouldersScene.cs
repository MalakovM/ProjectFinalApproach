...
{
    class ShouldersScene : Scene
    {
        public ShouldersScene() : base()
        {
            // Set scene content
            ...
            ColorMapSprite body = new ColorMapSprite("images/body/body_front_shoulders.png", "images/body/frontColorMap.png");
