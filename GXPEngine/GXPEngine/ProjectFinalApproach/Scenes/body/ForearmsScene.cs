...
{
    class ForearmsScene : Scene
    {
        public ForearmsScene() : base()
        {
            // Set scene content
            ...
            ColorMapSprite body = new ColorMapSprite("images/body/body_front_forearms.png", "images/body/frontColorMap.png");
